  ...
  return (
    <MessageScrollerProvider>
      <Card className=" h-screen max-h-screen rounded-none bg-main pt-0">
        <Header
          title="Chat Bot"
          Icon={routeIcons["/dashboard/chatBot"]}
          description="Chat with an AI assistant to ask questions, explore ideas, and get intelligent answers"
        />
            ...
            <Empty className="text-center mt-30">
              <EmptyHeader>
                ...
                <EmptyDescription className="text-secondary">
                  Enter a URL to index a website using the /url: URL command,
                  then ask questions and explore its content with the AI
                  assistant.
                </EmptyDescription>
              </EmptyHeader>
            </Empty>
